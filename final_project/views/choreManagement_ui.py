...
class Ui_choreManagementWindow(object):
    def setupUi(self, choreManagementWindow):
        ...
        choreManagementWindow.resize(350, 355)
        ...
        self.notesLabel.setGeometry(QtCore.QRect(10, 130, 121, 31))
        self.notesLabel.setObjectName("notesLabel")
        self.notesInput = QtWidgets.QPlainTextEdit(parent=self.centralwidget)
        self.notesInput.setGeometry(QtCore.QRect(10, 160, 311, 101))
        self.notesInput.setObjectName("notesInput")
        self.charCount = QtWidgets.QLabel(parent=self.centralwidget)
        self.charCount.setGeometry(QtCore.QRect(10, 270, 81, 16))
        self.charCount.setObjectName("charCount")
        self.submitBtn = QtWidgets.QPushButton(parent=self.centralwidget)
        self.submitBtn.setGeometry(QtCore.QRect(230, 270, 93, 28))
